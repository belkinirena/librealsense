...
{
    auto bs = VALIDATE_INTERFACE(sensor->sensor, librealsense::software_sensor);
    return bs->add_stream(video_stream)->get_c_wrapper();
}
...
{
    auto bs = VALIDATE_INTERFACE(sensor->sensor, librealsense::software_sensor);
    return bs->add_stream(motion_stream)->get_c_wrapper();
}
...
{
    auto bs = VALIDATE_INTERFACE(sensor->sensor, librealsense::software_sensor);
    return bs->add_stream(pose_stream)->get_c_wrapper();
}

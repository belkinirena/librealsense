...
namespace Intel.RealSense
{
    ...
    public enum FrameMetadataValue
    {
        ...
        Rs2FrameMetadataTemperature = 8,
        Rs2FrameMetadataBackendTimestamp = 9,
        Rs2FrameMetadataActualFps = 10,
        Rs2FrameMetadataFrameLaserPower = 11,
        Rs2FrameMetadataFrameLaserPowerMode = 12,
        Rs2FrameMetadataExposurePriority = 13,
        Rs2FrameMetadataExposureRoiLeft = 14,
        Rs2FrameMetadataExposureRoiRight = 15,
        Rs2FrameMetadataExposureRoiTop = 16,
        Rs2FrameMetadataExposureRoiBottom = 17,
        Rs2FrameMetadataBrightness = 18,
        Rs2FrameMetadataContrast = 19,
        Rs2FrameMetadataSaturation = 20,
        Rs2FrameMetadataSharpness = 21,
        Rs2FrameMetadataAutoWhiteBalanceTemperature = 22,
        Rs2FrameMetadataBacklightCompensation = 23,
        Rs2FrameMetadataHue = 24,
        Rs2FrameMetadataGamma = 25,
        Rs2FrameMetadataManualWhiteBalance = 26,
        Rs2FrameMetadataPowerLineFrequency = 27,
        Rs2FrameMetadataowLightCompensation = 28,
        Rs2FrameMetadataCount = 29,
    }
